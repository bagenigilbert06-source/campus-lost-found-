...
const Askqu = memo(function Askqu() {
            ...
            notifications: [
                {
                    ...
                    answer:
                        'Yes. If notification preferences are enabled, you will receive an email or SMS when a matching item is found. Go to Settings > Notifications to customize your preferences.',
                },
                {
                    question: 'How can I manage my notification settings?',
                    answer:
                        'Visit Settings > Notification Settings to choose which notifications you want, such as item matches, status updates, new found items in your category, and claim confirmations.',
                },
                {
                ...
                },
                {
                    ...
                    answer:
                        'Notifications are sent immediately when a match is found. You can choose to receive them via email, SMS, or in-app notifications based on your available preferences.',
                },
            ],
        }),
        []
            ...
            <div className="mx-auto max-w-5xl">
                ...
                >
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600 md:text-lg">
                        Everything you need to know about reporting, claiming, and managing
                        lost and found items on the platform.
                    </p>
                </motion.div>
                    ...
                    {categories.map((category) => {
                        ...
                        return (
                            <button
                                ...
                                className={`inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-200 md:px-5 ${isActive
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-emerald-50/90 md:text-base">
                            ...
                            items, claims, notifications, or account support.
                        </p>
