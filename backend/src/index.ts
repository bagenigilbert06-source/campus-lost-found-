...
// Disable automatic ETag-based 304 responses for APIs to ensure fresh data in the client.
app.set('etag', false);

// Prevent browser caching on dynamic API routes (notifications/messages/claims etc.)
